...
from utils import *
from utils.line_searches import line_search, intermediate_line_search
from utils.power_method import condition_number as cn
...
def cpo_step(env_name, policy_net, value_net, states, actions, returns, advantages, cost_advantages,
    ...
    if env_name == "CartPole-v0" or env_name == "CartPole-v1" or env_name == "MountainCar-v0" or env_name == "LunarLander-v2":
    ...
    cost_stepdir, r2 = conjugate_gradients(Fvp, -cost_loss_grad, cg_its) #(H^-1)*a
    ...
    success, new_params = intermediate_line_search(policy_net, get_loss, prev_params, fullstep, expected_improve, cc, cost_loss_grad, feasible)
